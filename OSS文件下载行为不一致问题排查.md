...
- **测试环境**（`sep-test-bucket`）：点击文件链接 → **自动下载** ✅
- **正式环境**（`wanzhi-bucket`）：点击文件链接 → **浏览器直接预览** ❌
...
| `Owner ID` | 1383279901179556 | 1383279901179556 | ✅ |
...
| 环境 | 域名 | 浏览器默认行为 |
|------|------|--------------|
| 测试 | `sep-test-bucket.oss-ap-southeast-1.aliyuncs.com` | 下载 ✅ |
| 正式 | `oss.sciexplor.com` | 预览 ❌ |
...
| 日期 | 版本 | 变更内容 | 负责人 |
|------|------|---------|--------|
| 2026-04-22 | v1.0 | 初始版本，记录问题排查过程和解决方案 | scy |
